  ...
  return (
    ...
    >
      <Link href="/" className="flex items-center gap-3">
        ...
        />
        <span className="text-2xl font-medium text-primary">New Gaia Collective</span>
      </Link>
      <nav>
        <motion.a
          href="/fellowship"
          className="text-primary text-xl px-4 py-4 hover:text-accent-coral transition-colors"
